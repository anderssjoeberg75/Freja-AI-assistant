...
def BigIntPK():
    """Returns BigInteger column type that degrades to Integer under SQLite for ROWID autoincrement compatibility."""
...
class ApiKey(Base):
    ...
    user_id = Column(BigInteger, primary_key=True, default=1)
